    ...
    return (
        <div>
            <div className="content-header">
                <h1>Create List <small>Add or segment a new list</small></h1>
            </div>
                ...
                <Col xs={12} md={12}>
                      <div className="nav-tabs-custom">
                        <ul className="nav nav-tabs pull-right">
                          <li className=""><a href="#tab_1-1" data-toggle="tab" aria-expanded="false">Tab 1 (Add email)</a></li>
                          <li><a href="#tab_2-2" data-toggle="tab">Tab 2 (Segment list)</a></li>
                          <li className="active"><a href="#tab_3-2" data-toggle="tab" aria-expanded="true">Import CSV</a></li>
