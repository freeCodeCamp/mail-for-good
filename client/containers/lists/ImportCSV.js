          ...
          : <Row>
            <Col md={12}>
              ...
              <div className="box">
                <div className="box-header with-border">
                  <h2>Import CSV</h2>
                  <h3 className="box-title"><i className="fa fa-exclamation-circle text-red"/>
                    Please ensure the first row of the CSV file contains column names. This row must contain an email header.</h3>
                </div>
